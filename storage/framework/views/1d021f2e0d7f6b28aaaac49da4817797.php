<div class="lqd-accordion-item group">
	<button data-target="#<?php echo e($id); ?>" data-trigger-type="accordion" class="flex items-center justify-between w-full py-5 pl-4 text-heading-foreground text-left text-[20px] font-normal tracking-wide border-b group/btn group-last:border-b-0">
		<span>
			<?php echo $title; ?>
	...
	<div id=<?php echo e($id); ?> class="hidden">
		<div class="py-4 pl-3 lqd-accordion-content">
			<p class="text-lg max-sm:text-[17px]"><?php echo $content; ?></p>
		</div>
	</div>
</div><?php /**PATH D:\project laravel\magicai\resources\views/default/components/accordion-item.blade.php ENDPATH**/ ?>