...
if (! empty($color) && isset($color_variants[$color])) {
    $wrapper_classnames[] = $color_variants[$color];
}

?>
<div class="<?php echo e(implode( ' ', $wrapper_classnames )); ?>">
	<span class="<?php echo e(implode( ' ', $dot_classnames )); ?> !bg-current"></span>
	<h3 class="text-xl text-inherit -tracking-tight"><?php echo e($title); ?></h3>
</div>
<?php /**PATH D:\project laravel\magicai\resources\views/default/components/color-box.blade.php ENDPATH**/ ?>