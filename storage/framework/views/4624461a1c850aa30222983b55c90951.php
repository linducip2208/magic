<div class="group mx-auto flex max-w-[270px] flex-col items-center text-center text-[18px] font-medium">
    ...
    ><?php echo e(__($item->order)); ?></span>
    <p><?php echo __($item->title); ?></p>
</div>
<?php /**PATH D:\project laravel\magicai\resources\views/default/landing-page/how-it-works/item.blade.php ENDPATH**/ ?>