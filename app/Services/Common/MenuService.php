...
class MenuService
{
    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ext_phone_call_agent' => [
                'parent_key'       => null,
                'key'              => 'ext_phone_call_agent',
                'route'            => 'dashboard.phone-call-agent.index',
                'label'            => 'Phone Call Agent',
                'data-name'        => 'ext_phone_call_agent',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.phone-call-agent.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            'ext_phone_call_agent_dashboard' => [
                'parent_key'       => 'ext_phone_call_agent',
                'key'              => 'ext_phone_call_agent_dashboard',
                'route'            => 'dashboard.phone-call-agent.index',
                'label'            => 'Dashboard',
                'data-name'        => null,
            ...
            'ext_phone_call_agent_history' => [
                'parent_key'       => 'ext_phone_call_agent',
                'key'              => 'ext_phone_call_agent_history',
                'route'            => 'dashboard.phone-call-agent.history',
                'label'            => 'Call History',
                'data-name'        => null,
                'icon'             => 'tabler-history',
                'svg'              => null,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.phone-call-agent.history',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            'ext_phone_call_agent_new' => [
                'parent_key'       => 'ext_phone_call_agent',
                'key'              => 'ext_phone_call_agent_new',
                'route'            => 'dashboard.phone-call-agent.new',
                'label'            => 'Create Agent',
                'data-name'        => null,
                'icon'             => 'tabler-plus',
                'svg'              => null,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.phone-call-agent.new',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            ...
            'ai_agent' => [
                'parent_key'       => null,
                'key'              => 'ai_agent',
                'route'            => 'dashboard.user.ai-agent.dashboard',
                'label'            => 'AI Agent',
                'icon'             => 'tabler-robot',
                'svg'              => null,
                'order'            => 4,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.ai-agent.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent'),
            ],
            'ai_agent_dashboard' => [
                'parent_key'       => 'ai_agent',
                'key'              => 'ai_agent_dashboard',
                'route'            => 'dashboard.user.ai-agent.dashboard',
                'label'            => 'Dashboard',
                'icon'             => 'tabler-layout-dashboard',
                'svg'              => null,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.ai-agent.dashboard',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent'),
            ],
            'ai_agent_workflows' => [
                'parent_key'       => 'ai_agent',
                'key'              => 'ai_agent_workflows',
            ...
            'ai_agent_messages' => [
                'parent_key'       => 'ai_agent',
                'key'              => 'ai_agent_messages',
                'route'            => 'dashboard.user.ai-agent.messages.index',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.user.ai-agent.messages.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent'),
            ],
            'ext_chat_bot_agent' => [
            ...
            'shared_credit_costs' => [
                ...
                'extension'        => null,
                'active_condition' => [
                    'dashboard.admin.finance.shared-credit-costs.*',
                ],
                'show_condition' => (bool) setting('shared_credit_system_enabled'),
                'is_admin'       => true,
            ],
            'shared_credit_migration' => [
                'parent_key'       => 'finance',
                'key'              => 'shared_credit_migration',
                'route'            => 'dashboard.admin.finance.credit-migration.index',
                'label'            => 'Credit Migration',
                'icon'             => null,
                'svg'              => null,
                'order'            => 66,
                'is_active'        => true,
                ...
                'extension'        => null,
                'active_condition' => [
                    'dashboard.admin.finance.credit-migration.*',
                ],
                'show_condition' => (bool) setting('shared_credit_system_enabled'),
                'is_admin'       => true,
            ],
    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        $menu = array_merge($menu, [
            ...
            'phone_call_agent_settings_extension' => [
                'parent_key'       => 'settings',
                'key'              => 'phone_call_agent_settings_extension',
                'route'            => 'dashboard.phone-call-agent.admin.settings',
                'label'            => 'Phone Call Agent Settings',
                'icon'             => null,
                'svg'              => null,
                'order'            => 80,
                'is_active'        => true,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.phone-call-agent.admin.settings',
                ],
                'show_condition' => Route::has('dashboard.phone-call-agent.admin.settings'),
            ],
            ...
            'marketing_bot_admin_settings' => [
                'parent_key'       => 'settings',
                'key'              => 'marketing_bot_admin_settings',
                'route'            => 'dashboard.admin.marketing-bot.settings.index',
                'label'            => 'Marketing Bot Settings',
                'data-name'        => null,
                'icon'             => null,
                'svg'              => null,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.admin.marketing-bot.settings.index',
                ],
                'show_condition'   => MarketplaceHelper::isRegistered('marketing-bot'),
                'is_admin'         => true,
            ],
            'ext_ai_agent_settings' => [
                'parent_key'       => 'settings',
                'key'              => 'ext_ai_agent_settings',
                'route'            => 'dashboard.admin.ai-agent.settings',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.admin.ai-agent.settings',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent'),
                'is_admin'       => true,
            ],
            'ext_ai_agent_gmail_settings' => [
                'parent_key'       => 'settings',
                'key'              => 'ext_ai_agent_gmail_settings',
                'route'            => 'dashboard.admin.ai-agent.gmail.settings',
                'label'            => 'AI Agent - Gmail Settings',
                'data-name'        => null,
                'icon'             => null,
                'svg'              => null,
                'order'            => 81,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.admin.ai-agent.gmail.settings',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent-gmail'),
                'is_admin'       => true,
            ],
            'ext_ai_agent_outlook_settings' => [
                'parent_key'       => 'settings',
                'key'              => 'ext_ai_agent_outlook_settings',
                'route'            => 'dashboard.admin.ai-agent.outlook.settings',
                'label'            => 'AI Agent - Outlook Settings',
                'data-name'        => null,
                'icon'             => null,
                'svg'              => null,
                'order'            => 82,
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.admin.ai-agent.outlook.settings',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('ai-agent-outlook'),
                'is_admin'       => true,
            ],
        ]);
    ...
    public static function planAiToolsMenu(): array
    {
        $keys = [
            ...
            'ext_social_media_automation', 'ai_captions', 'ai_agent',
        ];
        ...
        if (MarketplaceHelper::isRegistered('phone-call-agent')) {
            $result[] = [
                'key'   => 'ext_phone_call_agent',
                'label' => 'Phone Call Agent',
                'icon'  => 'tabler-phone-call',
